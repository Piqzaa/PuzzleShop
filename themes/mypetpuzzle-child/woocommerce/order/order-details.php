...
?>
<section class="checkout-page__section woocommerce-order-details">
	<?php do_action( 'woocommerce_order_details_before_order_table', $order ); ?>

	<h2 class="checkout-page__section-title"><?php esc_html_e( 'Order details', 'woocommerce' ); ?></h2>
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<tfoot>
			...
			foreach ( $order->get_order_item_totals() as $key => $total ) {
				$total_class = 'order-total-row';
				if ( 'order_total' === $key ) {
					$total_class .= ' order-total-row--total';
				}
				?>
			...
			<?php if ( $order->get_customer_note() ) : ?>
				<tr class="order-total-row order-total-row--note">
